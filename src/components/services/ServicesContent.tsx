...
import { Service, PricingTier, ProcessStep } from "@/lib/data/types"; // Import types
...
export default function ServicesContent({ services, pricingTiers, processSteps }: ServicesContentProps) {
    ...
    return (
        <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        {processSteps.map((step, index) => (
                            ...
                            >
                                ...
                                {index < processSteps.length - 1 && ( // Korrekte Bedingung für den Pfeil
            ...
            {/* Pricing Section (previously commented out, now included) */}
            <section className="py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        initial="hidden"
